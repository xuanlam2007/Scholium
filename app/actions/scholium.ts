...
/**
 * Toggle waiting room on/off for a scholium (host only)
 */
...
/**
 * Get waiting room status and pending users for a scholium
 */
...
/**
 * Approve a user from the waiting room (host/cohost only)
 */
...
/**
 * Deny a user from the waiting room (host/cohost only)
 */
...
/**
 * Request to join a scholium (used when waiting room is enabled)
 */
...
/**
 * Check if current user is pending in a scholium's waiting room
 */
